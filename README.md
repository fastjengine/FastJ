...
- [x] Support for: **Windows**, **Linux**, and **Mac OS**.

The original version of this library can be found [here][fastj-engine link].


## Adding FastJ to your project
This ECS can be found on [Maven Central][Maven-Central], and can be grabbed
...
From there, explore the [example code][FastJ-Example], play around with it, and read the documentation to get a better
...
[Ubuntu-Build-SVG]: https://img.shields.io/github/workflow/status/lucasstarsz/FastJ-Game-Library/Build-Ubuntu?label=Ubuntu%20Build&labelColor=363e45&logo=ubuntu&logoColor=E95420&style=for-the-badge
...
[MacOS-Build-SVG]: https://img.shields.io/github/workflow/status/lucasstarsz/FastJ-Game-Library/Build-MacOS?label=Mac%20OS%20Build&labelColor=363e45&logo=apple&logoColor=000000&style=for-the-badge
