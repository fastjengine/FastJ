...
public class Pointf {
  ...
  /**
   * Static method to add two {@code Pointf}s (from the parameters specified) together, and return a
   * new {@code Pointf} object.
   *
   ...
   * @return Returns a new {@code Pointf} with coordinates equal to the added values from the {@code
   *     Pointf} and the float value.
   */
   ...
   * {@code Pointf} object.
   *
   * @param p1 The first {@code Pointf} used for subtraction; the {@code Pointf} acting as the first
  ...
  /**
   * Static method to subtract a {@code Pointf} object by a float value, and return a new {@code
   * Pointf}.
   *
   * @param p The {@code Pointf} used for subtraction; the {@code Pointf} acting as the first value
   *     in subtraction.
  ...
  /**
   * Static method to multiply two {@code Pointf} objects (from the parameters specified) together,
   * and return a new {@code Pointf}.
   *
  ...
  /**
   * Static method to multiply a {@code Pointf} object by a float value, and return a new {@code
   * Pointf}.
   *
  ...
  /**
   * Static method to divide two {@code Pointf} objects (from the parameters specified) together,
   * and return a new {@code Pointf}.
   *
   * @param p1 The first {@code Pointf} used for division; the {@code Pointf} acting as the first
   *     value in division.
   * @param p2 The second {@code Pointf} used for division; the {@code Pointf} acting as the second
   *     value in division.
   * @return Returns a new {@code Pointf} with coordinates equal to the divided values from the two
   *     {@code Pointf}s.
   */
  ...
  /**
   * Static method to divide a {@code Pointf} object by a float value, and return a new {@code
   * Pointf}.
   *
   * @param p The {@code Pointf} used for division; the {@code Pointf} acting as the first value in
   *     division.
   ...
   *
   * <p>Unlike calculating the cross product of two 3-dimensional vectors, this cross product
   * calculates as if the two {@code Pointf}s were 3-dimensional vectors with Z values implicitly
   * set to {@code 0f}.
   *
   ...
   *
   * <p>This rotation method rotates about the origin, {@code (0, 0)}. If you need to rotate about a
   * point that is not the origin, use {@link #rotate(float, Pointf)}.
   *
   ...
   *
   * <p>This rotation method rotates about the specified {@code center}. If you need to rotate about
   * the origin, use {@link #rotate(Pointf, float)}.
   *
   * @param p The point to rotate.
   * @param angle The angle to rotate by, in degrees.
  ...
  public static float angle(Pointf p, Pointf p1) {
    float dotProduct = (p.x * p1.x) + (p.y * p1.y);
    float magnitudeProduct =
        (float) Math.sqrt((p.x * p.x) + (p.y * p.y))
            * (float) Math.sqrt((p1.x * p1.x) + (p1.y * p1.y));

    return (float) Math.acos(dotProduct / magnitudeProduct);
  }

  /**
   * Creates a new {@link Pointf}, applying to it the linear interpolation of the two {@link
   * Pointf}s specified.
   *
   * @param p The starting value.
   * @param p1 The ending value.
   * @param t The interpolation value to work with (preferably within a range of 0.0 to 1.0). This
   *     value will be used for linear interpolation of the {@code Pointf}'s {@code x} and {@code y}
   *     values.
  ...
  public static Pointf lerp(Pointf p, Pointf p1, float t) {
    return new Pointf(Maths.lerp(p.x, p1.x, t), Maths.lerp(p.y, p1.y, t));
  }
   ...
   * @param p The starting value.
   * @param p1 The ending value.
   * @param t1 The first interpolation value to work with (preferably within a range of 0.0 to 1.0).
   *     This value will be used for linear interpolation of the {@code Pointf}'s {@code x} value.
   * @param t2 The second interpolation value to work with (preferably within a range of 0.0 to
   *     1.0). This value will be used for linear interpolation of the {@code Pointf}'s {@code y}
   *     value.
   * @return A new {@code Pointf}, linearly interpolated as specified.
   * @see Maths#lerp(float, float, float)
   * @since 1.5.0
  ...
  public static Pointf lerp(Pointf p, Pointf p1, float t1, float t2) {
    return new Pointf(Maths.lerp(p.x, p1.x, t1), Maths.lerp(p.y, p1.y, t2));
  }

  /**
   * Calculates the linear interpolation values based on the provided {@code p} and {@code p1}
   * {@code Pointf} range, and the value {@code v}.
   *
   * @param p The starting value.
   * @param p1 The ending value.
   * @param v The value representing the "result" of linear interpolation between the two {@code
   *     Pointf}s. This value will be used to calculate inverse linear interpolation for the {@code
   *     Pointf}s' {@code x} and {@code y} values.
   * @return An array of floats containing the resulting inverse linear interpolations of the {@code
   *     Pointf}s' {@code x} and {@code y} values.
   * @see Maths#inverseLerp(float, float, float)
   * @since 1.5.0
   */
  public static float[] inverseLerp(Pointf p, Pointf p1, float v) {
    return new float[] {Maths.inverseLerp(p.x, p1.x, v), Maths.inverseLerp(p.y, p1.y, v)};
  }

  /**
   * Calculates the linear interpolation values based on the provided {@code p} and {@code p1}
   * {@code Pointf} range, and the values {@code v1} and {@code v2}.
   *
   * @param p The starting value.
   * @param p1 The ending value.
   * @param v1 The first value representing the "result" of linear interpolation between the two
   *     {@code Pointf}s. This value will be used to calculate inverse linear interpolation for the
   *     {@code Pointf}s' {@code x} value.
   * @param v2 The second value representing the "result" of linear interpolation between the two
   *     {@code Pointf}s. This value will be used to calculate inverse linear interpolation for the
   *     {@code Pointf}s' {@code y} value.
   * @return An array of floats containing the resulting inverse linear interpolations of the {@code
   *     Pointf}s' {@code x} and {@code y} values.
   * @see Maths#inverseLerp(float, float, float)
   * @since 1.5.0
  ...
  public static float[] inverseLerp(Pointf p, Pointf p1, float v1, float v2) {
    return new float[] {Maths.inverseLerp(p.x, p1.x, v1), Maths.inverseLerp(p.y, p1.y, v2)};
  }
   ...
   * Sets the x and y values of this {@code Pointf} object to the values specified.
   *
   * @param xy {@code float} value used to set the new x and y values for this {@code Pointf}
   *     object.
   */
   ...
   *
   * @param path Path2D object used to check for intersection between this {@code Pointf} object and
   *     it.
   * @return Returns a boolean value that defines whether the Path2D and this {@code Pointf} object
   *     intersect.
   */
  ...
  /**
   * Subtracts the values of this {@code Pointf} by the specified {@code Pointf}, and returns a new
   * {@code Pointf} with the modified values.
   *
  ...
  /**
   * Multiplies the values of this {@code Pointf} by the specified {@code Pointf}, and returns a new
   * {@code Pointf} with the modified values.
   *
   ...
   *
   * <p>This rotation method rotates about the specified {@code center}. If you need to rotate about
   * the origin, use {@link #rotate(float)}.
   *
   * @param angle The angle to rotate by, in degrees.
   * @param center The point to rotate around.
   * @return The {@code Pointf} with the rotated values.
   ...
   *
   * @return The magnitude, calculated using floating-point versions of the {@code Pointf}'s {@link
   *     #x} and {@link #y} values.
   */
   ...
   *
   * <p>This method does not modify the contents of the original {@code Pointf}.
   *
  ...
  /**
   * Compares the {@code Pointf} with a {@link Point}, and returns whether their {@code x} and
   * {@code y} values are equal.
   *
