...
public class Point {
  ...
  /**
   * {@code Point} constructor, where the values for the newly created {@code Point} are set to the
   * integer parameter's values.
   *
  ...
  /**
   * Static method to add two {@code Point}s (from the parameters specified) together, and return a
  ...
  /**
   * Static method to add a {@code Point} object by an integer value, and return a new {@code
   * Point}.
   *
   * @param p The {@code Point} used for addition.
   * @param i Integer value used for addition.
   * @return Returns a new {@code Point} with coordinates equal to the added values from the {@code
   *     Point} and the integer value.
   */
   ...
   * @param p2 The second {@code Point} used for subtraction; the {@code Point} acting as the second
   *     value in subtraction.
  ...
  /**
   * Static method to subtract a {@code Point} object by an integer value, and return a new {@code
   * Point}.
   *
   * @param p The {@code Point} used for subtraction; the {@code Point} acting as the first value in
   *     subtraction.
  ...
  /**
   * Static method to multiply two {@code Point} objects (from the parameters specified) together,
   * and return a new {@code Point}.
   *
  ...
  /**
   * Static method to multiply a {@code Point} object by an integer value, and return a new {@code
   * Point}.
   *
  ...
  /**
   * Static method to divide two {@code Point} objects (from the parameters specified) together, and
   * return a new {@code Point}.
   *
  ...
  /**
   * Static method to divide a {@code Point} object by an integer value, and return a new {@code
   * Point}.
   *
   ...
   * calculates as if the two {@code Point}s were 3-dimensional vectors with Z values implicitly set
   * to {@code 0}.
   *
   ...
   *
   * <p>This rotation method uses integer versions of the {@code Point}'s {@link #x} and {@link #y}
   * values, and returns the {@code Point} version of the calculation. If you want the rotation
   * calculated with floating-point math, use {@link Point#rotate(Point, float)} instead.
   *
   ...
   * the origin, use {@link #rotate(Point, float)}.
   *
   * @param p The point to rotate.
   * @param angle The angle to rotate by, in degrees.
   ...
   * Creates a rotated version of the {@code Point} based on the provided angle.
   *
   * <p>This rotation method uses floating-point versions of the {@code Point}'s {@link #x} and
   * {@link #y} values, and returns the {@code Pointf} version of the calculation. If you want the
   * rotation calculated with integer math, use {@link Point#integerRotate(Point, int)} instead.
   *
   * @param p The point to rotate.
   * @param angle The angle to rotate by, in degrees.
  ...
  public static float angle(Point p, Point p1) {
    ...
    float magnitudeProduct =
        (float) Math.sqrt((float) (p.x * p.x) + (float) (p.y * p.y))
            * (float) Math.sqrt((float) (p1.x * p1.x) + (float) (p1.y * p1.y));
   ...
   *
   * @param path Path2D object used to check for intersection between this {@code Point} object and
   *     it.
  ...
  /**
   * Adds the values of this {@code Point} to the specified {@code Point}, and returns a new {@code
   * Point} with the modified values.
   *
  ...
  /**
   * Adds the values of this {@code Point} to the specified integer value, and returns a new {@code
   * Point} with the modified values.
   *
   ...
   *
   * <p>This rotation method uses integer versions of the {@code Point}'s {@link #x} and {@link #y}
   * values, and returns the {@code Point} version of the calculation.
   *
   * @param angle The angle to rotate by, in degrees.
   ...
   *
   * <p>This rotation method rotates about the specified {@code center}. If you need to rotate about
   * the origin, use {@link #rotate(int)}.
   *
   * @param angle The angle to rotate by, in degrees.
   * @param center The point to rotate about.
   ...
   *
   * <p>This magnitude method uses integer versions of the {@code Point}'s {@link #x} and {@link #y}
   * values, and returns the {@code int} version of the calculation. If you want the magnitude
   * calculated with floating-point math, use {@link #magnitude()} instead.
   *
   * @return The magnitude, calculated using floating-point versions of the {@code Point}'s {@link
   *     #x} and {@link #y} values.
   */
   ...
   * Calculates and returns the {@code length}, or {@code magnitude}, of the {@code Point}.
   *
   * <p>This magnitude method uses floating-point versions of the {@code Point}'s {@link #x} and
   * {@link #y} values, and returns the {@code float} version of the calculation. If you want the
   * magnitude calculated with integer math, use {@link #integerMagnitude()} instead.
   *
   * @return The magnitude, calculated using floating-point versions of the {@code Point}'s {@link
   *     #x} and {@link #y} values.
   */
   ...
   *
   * <p>This method does not modify the contents of the original {@code Point}. If the desired
   * result requires a {@code Pointf} or floating-point division, consider using {@link
   * #normalized()} instead.
   *
  ...
  /**
   * Creates a normalized version of the {@code Point}, as a {@code Pointf}, using floating-point
   * division.
   *
   * <p>This method does not modify the contents of the original {@code Point}. If the desired
   * result requires a {@code Point} or integer division, consider using {@link
   * #integerNormalized()} instead.
   *
  ...
  /**
   * Compares the {@code Point} with a {@link Pointf}, and returns whether their {@code x} and
  ...
  /**
   * Compares the {@code Point} with a {@link Dimension}, and returns whether the {@code Point}'s
   * {@code x} and {@code y} values are equal to the {@code Dimension}'s {@code width} and {@code
   * height} values, respectively.
   *
   * @param other The {@code Dimension} to compare against.
   * @return Whether the two's {@code x}/{@code width} and {@code y}/{@code height} values are
   *     equal.
   */
