...
public class Model2D extends GameObject {
   ...
   *
   * <p>This constructor defaults the {@code shouldRender} boolean to {@link
  ...
  /**
   * Gets a {@link Model2DBuilder} instance while setting the eventual {@link Model2D}'s {@code
   * points} field.
   *
   * <p>
   *
