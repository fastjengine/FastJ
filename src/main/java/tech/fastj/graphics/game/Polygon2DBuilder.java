...
public class Polygon2DBuilder {
  ...
  /**
   * {@code Polygon2DBuilder} constructor, taking in a set of points, a render style, and a {@code
   * shouldRender} boolean.
   *
   * @param points The {@code Pointf} array of mesh points to use for the resulting {@code
   *     Polygon2D}.
   * @param renderStyle The {@code RenderStyle} to use for the resulting {@code Polygon2D}.
   * @param shouldRender The "should render" {@code boolean} to use for the resulting {@code
   *     Polygon2D}.
   */
   ...
   *
   * @param outlineStroke The outline {@code BasicStroke} to be used in the resulting {@code
   *     Polygon2D}.
  ...
  public Polygon2DBuilder withOutline(BasicStroke outlineStroke, Color outlineColor) {
    this.outlineStroke =
        Objects.requireNonNull(outlineStroke, "The outline stroke must not be null.");
   ...
   *
   * @param translation The translation {@code Pointf} to be used in the resulting {@code
   *     Polygon2D}.
  ...
  public Polygon2DBuilder withTransform(Pointf translation, float rotation, Pointf scale) {
    this.translation =
        Objects.requireNonNull(translation, "The translation value must not be null.");
