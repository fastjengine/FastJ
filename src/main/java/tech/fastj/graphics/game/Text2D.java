...
public class Text2D extends GameObject {
   ...
   *
   * <p>This constructor defaults the fill paint to {@link #DefaultFill}, the font to {@link
   * #DefaultFont}, and sets the {@code shouldRender} boolean to {@link
  ...
  /**
   * Gets a {@link Text2DBuilder} instance while setting the eventual {@link Text2D}'s {@code text}
   * field.
   *
   * @param text {@code String} that defines the text for the {@code Text2D}.
  ...
  /**
   * Gets a {@link Text2DBuilder} instance while setting the eventual {@link Text2D}'s {@code text}
   * and {@code shouldRender} fields.
   *
   * @param text {@code String} that defines the text for the {@code Text2D}.
   * @param shouldRender {@code boolean} that defines whether the {@code Text2D} would be rendered
   *     to the screen.
   * @return A {@code Text2DBuilder} instance for creating a {@code Text2D}.
   */
   ...
   *
   * <p>This also sets the resulting metrics as the {@code Text2D}'s collision path.
   *
