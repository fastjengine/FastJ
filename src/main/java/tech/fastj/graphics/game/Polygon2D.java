...
public class Polygon2D extends GameObject {
  ...
  /**
   * {@link RenderStyle} representing the default render style as fill only, or {@link
   * RenderStyle#Fill}.
   */
   ...
   */
  public static final BasicStroke DefaultOutlineStroke =
      new BasicStroke(1f, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER, 1.0f);
   ...
   *
   * <p>This constructor defaults the fill paint to {@link #DefaultFill}, the outline stroke to
   * {@link #DefaultOutlineStroke}, the outline color to {@link #DefaultOutlineColor}, the render
   * style to {@link #DefaultRenderStyle}, and the {@code shouldRender} boolean to {@link
  ...
  /**
   * Gets a {@link Polygon2DBuilder} instance while setting the eventual {@link Polygon2D}'s {@code
   * points} field.
   *
   * <p>
   *
  ...
  /**
   * Gets a {@link Polygon2DBuilder} instance while setting the eventual {@link Polygon2D}'s {@code
   * points} and {@code shouldRender} fields.
   *
   * <p>
   *
   * @param points {@code Pointf} array that defines the points for the {@code Polygon2D}.
   * @param shouldRender {@code boolean} that defines whether the {@code Polygon2D} would be
  ...
  /**
   * Gets a {@link Polygon2DBuilder} instance while setting the eventual {@link Polygon2D}'s {@code
   * points} and {@code renderStyle} fields.
   *
   * <p>
   *
   * @param points {@code Pointf} array that defines the points for the {@code Polygon2D}.
  ...
  /**
   * Gets a {@link Polygon2DBuilder} instance while setting the eventual {@link Polygon2D}'s {@code
   * points}, {@code renderStyle}, and {@code shouldRender} fields.
   *
   * <p>
   *
   * @param points {@code Pointf} array that defines the points for the {@code Polygon2D}.
   ...
   * @return A {@code Polygon2DBuilder} instance for creating a {@code Polygon2D}.
   */
  public static Polygon2DBuilder create(
      Pointf[] points, RenderStyle renderStyle, boolean shouldRender) {
   ...
   *
   * <p>This does not reset the rotation, scale, or location of the original, unless specified with
  ...
  public void modifyPoints(
      Pointf[] points, boolean resetTranslation, boolean resetRotation, boolean resetScale) {
    originalPoints = points;
  ...
  public String toString() {
    return "Polygon2D{"
        + "originalPoints="
        + Arrays.toString(originalPoints)
        + ", renderStyle="
        + renderStyle
        + ", fillPaint="
        + fillPaint
