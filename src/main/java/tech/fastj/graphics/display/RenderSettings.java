...
/**
 * Based on the {@link RenderingHints} class, the {@code RenderSettings} class provides a simple way
 * to set rendering options using {@link Display#modifyRenderSettings(RenderSettings)}.
 *
 * @author Andrew Dey
 * @since 1.5.0
 */
public class RenderSettings {
  ...
  public static class Antialiasing {
    ...
    public static final RenderSettings Enable =
        new RenderSettings(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
    /** Render setting that disables anti-aliasing. */
    public static final RenderSettings Disable =
        new RenderSettings(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_OFF);
  }

  /**
   * Render settings to enable/disable text anti-aliasing, as well as specific optimizations for LCD
   * screens.
   */
  public static class TextAntialiasing {
     ...
     *
     * <p>This setting uses information in font resources that specifies for each point size whether
     * to enable or disable anti-aliasing.
     *
     * @see RenderingHints#VALUE_TEXT_ANTIALIAS_GASP
     */
    public static final RenderSettings Gasp =
        new RenderSettings(
            RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_GASP);
    /**
     * Render setting that enables anti-aliasing with LCD HRGB optimization.
     *
     * <p>This setting requests that text is optimized for an LCD display with sub-pixels displayed
     * left to right (R, G, B) such that the horizontal subpixel resolution is three times the full
     * pixel horizontal resolution (HRGB).
     *
     * @see RenderingHints#VALUE_TEXT_ANTIALIAS_LCD_HRGB
     */
    public static final RenderSettings LcdHrgb =
        new RenderSettings(
     ...
     *
     * <p>This setting requests that text is optimized for an LCD display with sub-pixels displayed
     * left to right (B, G, R) such that the horizontal subpixel resolution is three times the full
     * pixel horizontal resolution (HBGR).
     *
     * @see RenderingHints#VALUE_TEXT_ANTIALIAS_LCD_HBGR
     */
    public static final RenderSettings LcdHbgr =
        new RenderSettings(
     ...
     * <p>This setting requests that text is optimized for an LCD display with sub-pixels displayed
     * left to right (R, G, B) such that the horizontal subpixel resolution is three times the full
     * pixel horizontal resolution (VRGB).
     *
     * @see RenderingHints#VALUE_TEXT_ANTIALIAS_LCD_VRGB
     */
    public static final RenderSettings LcdVrgb =
        new RenderSettings(
            RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_LCD_VRGB);
    /**
     * Render setting that enables anti-aliasing with LCD VBGR optimization.
     *
     * <p>This setting requests that text is optimized for an LCD display with sub-pixels displayed
     * left to right (B, G, R) such that the horizontal subpixel resolution is three times the full
     * pixel horizontal resolution (VBGR).
     *
     * @see RenderingHints#VALUE_TEXT_ANTIALIAS_LCD_VBGR
     */
    public static final RenderSettings LcdVbgr =
        new RenderSettings(
            RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_LCD_VBGR);
  }
  ...
  public static class GeneralRenderingQuality {
    ...
    public static final RenderSettings Low =
        new RenderSettings(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_SPEED);
    /** Render setting that opts for quality-accurate rendering algorithms. */
    public static final RenderSettings High =
        new RenderSettings(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY);
  }
  ...
  public static class ImageInterpolation {
     ...
     */
    public static final RenderSettings Bilinear =
        new RenderSettings(
     ...
     */
    public static final RenderSettings Bicubic =
        new RenderSettings(
     ...
     */
    public static final RenderSettings NearestNeighbor =
        new RenderSettings(
  ...
  public static class OutlineRenderingStyle {
    ...
    /**
     * Render setting that normalizes polygon outlines when rendering to improve rendering
     * uniformity.
     */
    public static final RenderSettings Normalize =
        new RenderSettings(
            RenderingHints.KEY_STROKE_CONTROL, RenderingHints.VALUE_STROKE_NORMALIZE);
    /**
     * Render setting that does not normalize polygon outlines when rendering, leaving it
     * unmodified.
     */
    public static final RenderSettings Unmodified =
        new RenderSettings(RenderingHints.KEY_STROKE_CONTROL, RenderingHints.VALUE_STROKE_PURE);
  }
  ...
  public static class ImageVariantResolution {
    ...
    public static final RenderSettings Standard =
        new RenderSettings(
            RenderingHints.KEY_RESOLUTION_VARIANT, RenderingHints.VALUE_RESOLUTION_VARIANT_BASE);
    /**
     * Render setting that specifies to choose image resolutions based on the camera transformation
     * and screen DPI.
     */
    ...
    public static final RenderSettings FitToScreenDPI =
        new RenderSettings(
            RenderingHints.KEY_RESOLUTION_VARIANT, RenderingHints.VALUE_RESOLUTION_VARIANT_DPI_FIT);
  }

  /**
   * Render settings that change the contrast level of text on LCD screens.
   *
   * <p>This setting should only be used in conjunction with one of the following settings:
   *
   * <ul>
   *   <li>{@link TextAntialiasing#LcdHrgb}
   *   <li>{@link TextAntialiasing#LcdHbgr}
   *   <li>{@link TextAntialiasing#LcdVrgb}
   *   <li>{@link TextAntialiasing#LcdVbgr}
   * </ul>
   */
  public static class TextLCDContrast {
    ...
    public static final RenderSettings Minimum =
        new RenderSettings(RenderingHints.KEY_TEXT_LCD_CONTRAST, 250);
    /** Render setting that specifies low contrast for text on LCD screens. */
    public static final RenderSettings Low =
        new RenderSettings(RenderingHints.KEY_TEXT_LCD_CONTRAST, 213);
    /** Render setting that specifies medium contrast for text on LCD screens. */
    public static final RenderSettings Medium =
        new RenderSettings(RenderingHints.KEY_TEXT_LCD_CONTRAST, 175);
    /** Render setting that specifies high contrast for text on LCD screens. */
    public static final RenderSettings High =
        new RenderSettings(RenderingHints.KEY_TEXT_LCD_CONTRAST, 138);
    /** Render setting that specifies the maximum possible contrast for text on LCD screens. */
    public static final RenderSettings Maximum =
        new RenderSettings(RenderingHints.KEY_TEXT_LCD_CONTRAST, 100);
    ...
    public static RenderSettings percentage(float percentage) {
      ...
      return new RenderSettings(
          ...
          Maths.denormalize((1.0f - percentage), MaximumValue, MinimumValue));
    }
  }
  ...
  public static class Dithering {
    ...
    public static final RenderSettings Enable =
        new RenderSettings(RenderingHints.KEY_DITHERING, RenderingHints.VALUE_DITHER_ENABLE);
    /** Render setting that disables dithering when rendering polygons. */
    public static final RenderSettings Disable =
        new RenderSettings(RenderingHints.KEY_DITHERING, RenderingHints.VALUE_DITHER_DISABLE);
  }
