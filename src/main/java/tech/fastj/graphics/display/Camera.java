...
public class Camera {
   ...
   *
   * @param setTranslation {@code Pointf} parameter that the {@code Camera}'s translation will be
   *     set to.
   ...
   *
   * @param translationMod {@code Pointf} parameter that the {@code Camera}'s x and y location will
   *     be translated by.
   */
  ...
  /**
   * Rotates the {@code Camera} in the direction of the specified rotation, about the specified
   * centerpoint.
   *
  ...
  /**
   * Scales the {@code Camera} in by the amount specified in the specified scale, from the specified
   * centerpoint.
   *
   * @param scaleMod {@code Pointf} parameter that the {@code Camera}'s width and height will be
   *     scaled by.
   ...
   *
   * @param scaleXY float parameter that the {@code Camera} will be scaled by, acting as both the x
   *     and y values.
   */
   ...
   * Scales the {@code Camera} in by the amount specified in the specified scale, about its center.
   *
   * @param scaleMod {@code Pointf} parameter that the {@code Camera} will be scaled by, based on
   *     its x and y values.
   */
  ...
  public String toString() {
    return "Camera{" + "transform=" + transform + '}';
  }
}
