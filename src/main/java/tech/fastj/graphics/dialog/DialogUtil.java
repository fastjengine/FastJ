 ...
 * <p>
 * When working with Swing components directly, it is highly recommended to use {@link
...
public class DialogUtil {
    ...
    /**
     * Creates a {@link JOptionPane#showMessageDialog(Component, Object, String, int, Icon) dialog with a message for
     * the user}.
     * <p>
    ...
    /**
     * Creates a {@link JOptionPane#showInputDialog(Component, Object, String, int, Icon, Object[], Object) dialog with
     * a simple text box for the user to input to}.
     * <p>
    ...
    /**
     * Creates a {@link JOptionPane#showConfirmDialog(Component, Object, String, int, int, Icon) dialog with a set of
     * buttons to confirm or deny a specified action}.
     * <p>
     * This dialog uses the {@link DialogMessageTypes#Question question} message type.
     *
     * @param dialogConfig  The dialog's configuration style.
     * @param dialogOptions The types of options to provide. In most multi-option cases, {@link
     *                      DialogOptions#YesNoCancel} should suffice.
    ...
    /**
     * Creates a {@link JOptionPane#showOptionDialog(Component, Object, String, int, int, Icon, Object[], Object) dialog
     * with a set of buttons to choose from, as options}.
     *
     * @param dialogConfig      The dialog's configuration style.
     ...
     * @return The index of the option the user chose. If the user exited the dialog or otherwise did not pick an
     * option, {@code -1} is the returned value.
     */
