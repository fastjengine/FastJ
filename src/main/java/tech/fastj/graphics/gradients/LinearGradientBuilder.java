...
public class LinearGradientBuilder implements GradientBuilder {
  ...
  /**
   * Sets the starting and ending points for the resulting gradient, based on the provided {@link
   * Drawable} and {@link Boundary} values.
   *
   * @param drawable The basis for what the {@code start} and {@code end} end positions evaluate to.
   * @param start The starting boundary to create the gradient from.
   * @param end The ending boundary to create the gradient from.
   ...
   *
   * <p>The amount of colors used in a {@link LinearGradientBuilder} cannot exceed {@link
  ...
  /**
   * Creates a new {@link LinearGradientPaint} object, using the data provided by earlier method
   * calls.
   *
  ...
  public LinearGradientPaint build() {
    ...
    return new LinearGradientPaint(
        from.x, from.y, to.x, to.y, Arrays.copyOf(fractions, count), Arrays.copyOf(colors, count));
  }
