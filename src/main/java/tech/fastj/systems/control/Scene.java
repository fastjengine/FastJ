 ...
 *
 * <p>A {@code SceneManager} of any game made with FastJ can store many scenes. Through this, the
...
public abstract class Scene implements BehaviorHandler, TagHandler {
  ...
  /**
   * Drawable manager instance for the scene -- it controls the scene's game objects and ui
   * elements.
   */
   ...
   *
   * <p>This method is best used for initializing any variables necessary at the beginning of
   * displaying a scene.
   *
   ...
   *
   * <p>This method is best used for destroying or and nullifying any variables used in the game.
   *
   * @param display The {@code Display} that the game renders to.
   */
   ...
   *
   * <p>This method is called on the current scene every time the engine updates its state.
   *
   * @param display The {@code Display} that the game renders to.
   */
