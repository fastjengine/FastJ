 ...
 *
 * <p>Behaviors go hand-in-hand with {@link GameObject}s. A {@code GameObject} can have as many
 * references to the same {@code Behavior} as you may want.
 *
 * @author Andrew Dey
 * @since 1.0.0
 */
public interface Behavior {
  ...
  /**
   * Gets an instance of {@code Behavior} that, when assigned to a {@code GameObject}, translates it
  ...
  /**
   * Gets an instance of {@code Behavior} that, when assigned to a {@code GameObject}, rotates it by
  ...
  /**
   * Gets an instance of {@code Behavior} that, when assigned to a {@code GameObject}, scales it by
   ...
   *
   * <p>This method is used for modifying anything about the GameObject(s) that this behavior is
   ...
   *
   * <p>This method is used to modify anything about the assigned {@code GameObject}, every time the
   * assigned {@code GameObject}'s containing {@code Scene} updates. It is called after the parent
