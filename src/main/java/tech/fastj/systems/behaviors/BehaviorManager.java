...
public class BehaviorManager {
  ...
  private static final Map<BehaviorHandler, Map<String, GameObject>> BehaviorListenerLists =
      new HashMap<>();
  ...
  /**
   * Adds the specified behavior listener to the list aliased to the specified {@link
   * BehaviorHandler}.
   *
   * @param behaviorHandler The {@code BehaviorHandler} used as the alias to add the specified
   *     behavior listener to.
   ...
   *
   * @param behaviorHandler The {@code BehaviorHandler} used as the alias to remove the specified
   *     behavior listener from.
  ...
  /**
   * Destroys all behaviors from the list aliased to the specified {@link BehaviorHandler}, without
   * removing them.
   *
   * @param behaviorHandler The {@code BehaviorHandler} used as the alias to destroy all behavior
   *     listeners.
   */
   ...
   *
   * @param behaviorHandler The {@code BehaviorHandler} used as the alias to remove all behavior
   *     listeners.
   */
   ...
   *
   * @param behaviorHandler The {@code BehaviorHandler} used as the alias to initialize the behavior
   *     listeners for.
   */
   ...
   *
   * @param behaviorHandler The {@code BehaviorHandler} used as the alias to update the behavior
   *     listeners for.
   */
