...
public class TagManager {
  ...
  /**
   * Adds the specified taggable entity to the list of taggable entities for the specified tag
   * handler.
   *
   * <p>The taggable entity is only added if the specified tag handler does not already contain the
  ...
  /**
   * Removes the specified taggable entity from the list of taggable entities for the specified tag
   * handler.
   *
   ...
   *
   * <p>The specified {@link TagHandler} is only added if it is not already in the tag manager.
   *
