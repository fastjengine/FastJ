...
public class FileUtil {
   ...
   *
   * <p>This method does <b>not</b> account for file extensions with more than one dot ({@code .})
   * -- in cases like those, only the last part of the extension will be returned.
   *
