...
public enum HWAccel {
   ...
   *
   * <p><b>NOTE:</b> This is only supported on Windows machines.
   */
   ...
   *
   * <p>If for some reason you want to do some reflection to try and call this method while the game
   * engine is running, let me save you some time. Regardless of calling this method, it will never
   * affect the hardware acceleration being used after any form of {@code FastJEngine#init} is
   * called.
   *
