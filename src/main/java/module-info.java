 ...
 *
 * <p>FastJ does not use any external dependencies -- it relies entirely on Java 11's {@code
 * java.desktop} module, using java2d to display output.
 *
 * <p>This game library is split into 5 parts:
 *
 * <ol>
 *   <li>{@link tech.fastj.engine} -- The package containing the base of the game engine.
 *   <li>{@link tech.fastj.graphics} -- Game objects and other graphical content.
 *   <li>{@link tech.fastj.input} -- User input via keyboard/mouse.
 *   <li>{@link tech.fastj.math} -- FastJ's supplementary mathematics and vector library.
 *   <li>{@link tech.fastj.systems} -- Audio, behaviors, and other miscellaneous features of FastJ.
 * </ol>
 *
 * <p>For more information, check out <a href="https://github.com/fastjengine/FastJ"
