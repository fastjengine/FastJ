...
public class Main extends SimpleManager {
  ...
  public void init(Display display) {
    ...
    Pointf[] smallSquareMeshByHand = {
      new Pointf(0f, 0f), new Pointf(0f, 50f), new Pointf(50f, 50f), new Pointf(50f, 0f)
    };
    ...
    BasicStroke largeSquareOutlineStroke =
    ...
    Polygon2D largeSquare =
        Polygon2D.create(largeSquareMesh, RenderStyle.FillAndOutline)
            .withFill(Color.blue)
