...
class EngineConfigTests {
    ...
    void checkEngineConfigDefaults_shouldMatchEngineDefaults() {
        ...
        assertEquals(FastJEngine.DefaultCanvasResolution, EngineConfig.Default.canvasResolution(), "The default engine config canvas cesolution should match the default canvas resolution.");
    ...
    void checkEngineConfigCreation_shouldMatchGeneratedValues() {
        ...
        Point canvasResolution = new Point(Maths.randomInteger(1, 1920), Maths.randomInteger(1, 1080));
        ...
        assertEquals(canvasResolution, engineConfig.canvasResolution(), "The engine config canvas cesolution should match the randomly generated canvas cesolution.");
