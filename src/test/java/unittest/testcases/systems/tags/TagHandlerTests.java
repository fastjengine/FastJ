...
class TagHandlerTests {
    ...
    void checkGetEntitiesWithTag_shouldNotFail() {
        ...
        assertEquals(expectedEntityCount, tagHandler.getAllWithTag(tag)
            .size(), "The number of entities retrieved should match the expected count.");
        assertEquals(taggableEntityWithTag, tagHandler.getAllWithTag(tag)
            .get(0), "The retrieved taggable entity should match the expected entity.");
