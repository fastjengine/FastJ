...
class KeysTests {
    ...
    assertDoesNotThrow(
        () -> {
          for (Keys key : Keys.values()) {
            ...
            assertEquals(
                key.getKeyCode(),
                equivalentKey.getKeyCode(),
                "The equivalent key code should match the expected key code.");
            assertEquals(
                key.getKeyLocation(),
                equivalentKey.getKeyLocation(),
                "The equivalent key location should match the expected key location.");
          }
        });
  }
  ...
  void checkGetKeys_withInvalidKeyCode_shouldNotReturnUndefined() {
    ...
    assertNotEquals(
        Keys.Undefined,
        actualKey,
        "Despite the key code being invalid, the key name is correct -- the returned key should not be Keys.Undefined.");
  ...
  void checkGetKeys_withInvalidKeyLocation_shouldNotReturnUndefined() {
    ...
    assertNotEquals(
        Keys.Undefined,
        actualKey,
        "Despite the key location being invalid, the key name is correct -- the returned key should not be Keys.Undefined.");
    assertEquals(expectedKey, actualKey, "The actual key's value should match the expected key.");
  }
  ...
  void checkGetKeys_withInvalidKeyCodeAndInvalidKeyLocation_shouldNotReturnUndefined() {
    ...
    assertNotEquals(
        Keys.Undefined,
        actualKey,
        "Despite both the key code and key location being invalid, the key name is correct -- the returned key should not be Keys.Undefined.");
    assertEquals(expectedKey, actualKey, "The actual key's value should match the expected key.");
  }
  ...
  void checkGetKeys_withInvalidKeyName_shouldReturnUndefined() {
    ...
    assertEquals(
        Keys.Undefined,
        actualKey,
        "The actual key's value should match Keys.Undefined, since the key name is invalid.");
  }
