...
class PointfTests {
  ...
  void checkPointfRotation_aroundOrigin() {
    ...
    assertEquals(
        expectedRotation,
        ptf,
        "The resulting rotation of the Pointf should equal the expected rotated value of "
            + expectedRotation
            + ".");
  }
  ...
  void checkPointfCopyingForEquality() {
    ...
    assertEquals(
        original,
        copy,
        "The two Pointf objects should have the same x and y values -- (13f, 37f).");
  }
  ...
  void checkPointfResettingForEquality_withPointfAtOrigin() {
    ...
    assertEquals(
        new Pointf(), ptf, "The Pointf's x and y values should have been reset to (0f, 0f).");
  }
  ...
  void checkPointfMagnitude_usingFloatingPointMagnitude() {
    ...
    assertEquals(
        expectedPtMagnitude,
        actualPtMagnitude,
        "The first Pointf's magnitude should equal the expected magnitude of (float) √8f.");

    Pointf pt2 = new Pointf(3f, 3f);
    float expectedPt2Magnitude = (float) Math.sqrt(18f);
    float actualPt2Magnitude = pt2.magnitude();
    assertEquals(
        expectedPt2Magnitude,
        actualPt2Magnitude,
        "The second Pointf's magnitude should equal the expected magnitude of (float) √18f.");
  }
  ...
  void checkPointfSquareMagnitude() {
    ...
    assertEquals(
        expectedSquareMagnitude,
        actualSquareMagnitude,
        "The Pointf's square magnitude should equal the expected magnitude of 1538f.");
  }
  ...
  void checkPointfNormalization() {
    ...
    assertEquals(
        ...
        actualNormalization,
        String.format(
            "The Pointf's normalized value should equal the expected values of %s",
            expectedNormalization));
  }
  ...
  void checkPointNormalization_whenMagnitudeIsZero() {
    ...
    assertEquals(
        ...
        actualNormalization,
        String.format(
            "The Point's normalized value when using floating-point division should equal the expected values of %s",
            expectedNormalization));
  }
  ...
  void checkEqualsAgainstPoint() {
    ...
    assertTrue(
        ptf.equalsPoint(pt), "The Pointf and Point should be equal in their x and y values.");
  }
  ...
  void static_checkPointfAngleCalculation() {
    ...
    assertEquals(
        expectedAngle,
        actualAngle,
        "The resulting angle of the two Pointfs should equal the expected angle of "
            + expectedAngle
            + ".");
    ...
    assertTrue(
        Maths.floatEquals(expectedAngle2, actualAngle2),
        "The resulting angle of the two Pointfs should equal the expected angle of "
            + expectedAngle2
            + ".");
  }
  ...
  void static_checkPointfSignedAngleCalculation() {
    ...
    assertTrue(
        Maths.floatEquals(expectedAngle, actualAngle),
        "The resulting signed angle of the two Pointfs should equal the expected angle of "
            + expectedAngle
            + ".");
  ...
  void static_checkDotProduct() {
    ...
    assertEquals(
        expectedDotProduct,
        actualDotProduct,
        "The resulting dot product of the two Pointfs should equal the expected dot product of 250f.");
  }
  ...
  void static_checkCrossProduct() {
    ...
    assertEquals(
        ...
        actualCrossProduct,
        "The resulting cross product of the two Pointfs should equal the expected cross product of 876.6225f.");
  }
  ...
  void static_checkLerp_withOneLerpValue() {
    ...
    assertEquals(
        expectedLerpResult1,
        actualLerpResult1,
        "The resulting lerped Pointf should equal the expected lerp result "
            + expectedLerpResult1
            + ".");
    assertEquals(
        expectedLerpResult2,
  ...
  void static_checkInverseLerp_withOneValue() {
    ...
    assertArrayEquals(
        expectedInverseLerpResult1,
        actualInverseLerpResult1,
        "The resulting inverse lerped Pointf should equal the expected inverse lerp result "
            + Arrays.toString(expectedInverseLerpResult1)
            + ".");
    assertArrayEquals(
        expectedInverseLerpResult2,
        actualInverseLerpResult2,
        "The resulting inverse lerped Pointf should equal the expected inverse lerp result "
            + Arrays.toString(expectedInverseLerpResult2)
            + ".");
    assertArrayEquals(
        expectedInverseLerpResult3,
        actualInverseLerpResult3,
        "The resulting inverse lerped Pointf should equal the expected inverse lerp result "
            + Arrays.toString(expectedInverseLerpResult3)
            + ".");
    assertArrayEquals(
        expectedInverseLerpResult4,
        actualInverseLerpResult4,
        "The resulting inverse lerped Pointf should equal the expected inverse lerp result "
            + Arrays.toString(expectedInverseLerpResult4)
            + ".");
    assertArrayEquals(
        expectedInverseLerpResult5,
        actualInverseLerpResult5,
        "The resulting inverse lerped Pointf should equal the expected inverse lerp result "
            + Arrays.toString(expectedInverseLerpResult5)
            + ".");
  }
  ...
  void static_checkInverseLerp_withTwoLerpValues() {
    ...
    float[] actualInverseLerpResult1 =
        Pointf.inverseLerp(ptf, ptf2, inverseLerpValue1[0], inverseLerpValue1[1]);
    float[] actualInverseLerpResult2 =
        Pointf.inverseLerp(ptf, ptf2, inverseLerpValue2[0], inverseLerpValue2[1]);
    float[] actualInverseLerpResult3 =
        Pointf.inverseLerp(ptf, ptf2, inverseLerpValue3[0], inverseLerpValue3[1]);
    float[] actualInverseLerpResult4 =
        Pointf.inverseLerp(ptf, ptf2, inverseLerpValue4[0], inverseLerpValue4[1]);
    float[] actualInverseLerpResult5 =
        Pointf.inverseLerp(ptf, ptf2, inverseLerpValue5[0], inverseLerpValue5[1]);
