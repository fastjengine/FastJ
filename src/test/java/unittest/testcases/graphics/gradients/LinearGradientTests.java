...
class LinearGradientTests {
  ...
  private static Pointf randomPointf() {
    return new Pointf(Maths.random(0.0f, 100.0f), Maths.random(0.0f, 100.0f));
  }
  ...
  void checkCreateLinearGradient_withTwoRandomColors_usingRandomLocations() {
    ...
    LinearGradientPaint expectedLinearGradientPaint =
    ...
    LinearGradientPaint actualLinearGradientPaint =
        Gradients.linearGradient(randomStartingPoint, randomEndingPoint)
            .withColor(randomColor1)
            .withColor(randomColor2)
            .build();

    assertEquals(
        expectedLinearGradientPaint.getStartPoint(),
        actualLinearGradientPaint.getStartPoint(),
        "The created linear gradient's starting point should match the expected linear gradient's starting point.");
    assertEquals(
        expectedLinearGradientPaint.getEndPoint(),
        actualLinearGradientPaint.getEndPoint(),
        "The created linear gradient's ending point should match the expected linear gradient's ending point.");
    assertArrayEquals(
        expectedLinearGradientPaint.getColors(),
        actualLinearGradientPaint.getColors(),
        "The created linear gradient's colors should match the expected linear gradient's colors.");
    assertEquals(
        expectedLinearGradientPaint.getCycleMethod(),
        actualLinearGradientPaint.getCycleMethod(),
        "The created linear gradient's cycle method should match the expected linear gradient's cycle method.");
    assertEquals(
        expectedLinearGradientPaint.getColorSpace(),
        actualLinearGradientPaint.getColorSpace(),
        "The created linear gradient's color space should match the expected linear gradient's color space.");
    assertEquals(
        expectedLinearGradientPaint.getTransform(),
        actualLinearGradientPaint.getTransform(),
        "The created linear gradient's transform should match the expected linear gradient's transform.");
    assertEquals(
        expectedLinearGradientPaint.getTransparency(),
        actualLinearGradientPaint.getTransparency(),
        "The created linear gradient's transparency should match the expected linear gradient's transparency.");
  ...
  void checkCreateLinearGradient_withSixRandomColors_usingRandomLocations() {
    ...
    LinearGradientPaint expectedLinearGradientPaint =
        new LinearGradientPaint(
            ...
            new Color[] {
              randomColor1, randomColor2, randomColor3, randomColor4, randomColor5, randomColor6
            });
  ...
  @Test
  void
      checkCreateLinearGradient_withThreeRandomColors_usingRandomLocations_usingWithColorsMethod() {
    Color randomColor1 = randomColor();
    Color randomColor2 = randomColor();
    Color randomColor3 = randomColor();
  ...
  @Test
  void
      checkCreateLinearGradient_withSevenRandomColors_usingRandomLocations_usingWithColorsMethod() {
    Color randomColor1 = randomColor();
    Color randomColor2 = randomColor();
    Color randomColor3 = randomColor();
    Color randomColor4 = randomColor();
  ...
  @Test
  void
      checkCreateLinearGradient_withEightRandomColors_usingRandomLocations_usingWithColorsMethod() {
    Color randomColor1 = randomColor();
    Color randomColor2 = randomColor();
    Color randomColor3 = randomColor();
    Color randomColor4 = randomColor();
  ...
  void tryCreateLinearGradient_butPositionUsesTheSamePointfsForStartAndEndParams() {
    ...
    Throwable exception =
        assertThrows(
            ...
            () ->
                Gradients.linearGradient(invalid_startAndEndPosition, invalid_startAndEndPosition));

    String expectedExceptionMessage =
        "The starting and ending positions for a gradient must not be the same."
            + System.lineSeparator()
            + "Both positions evaluated to: "
            + invalid_startAndEndPosition;
    assertEquals(
  ...
  void tryCreateLinearGradient_butPositionUsesTheSameBoundariesForStartAndEndParams() {
    ...
    Boundary invalid_startAndEndPosition =
        Boundary.values()[Maths.randomInteger(0, Boundary.values().length - 1)];
    Throwable exception =
        assertThrows(
            IllegalArgumentException.class,
            () ->
                Gradients.linearGradient(
                    mockDrawable, invalid_startAndEndPosition, invalid_startAndEndPosition));

    String expectedExceptionMessage =
        "The starting and ending positions for a gradient must not be the same."
            + System.lineSeparator()
            + "Both positions evaluated to: "
            + invalid_startAndEndPosition.name();
    assertEquals(
        expectedExceptionMessage,
        exception.getMessage(),
        "The thrown exception's message should match the expected exception message.");
  ...
  void tryCreateLinearGradient_butTooManyColorsWereAdded_usingWithColor() {
    ...
    Throwable exception =
        assertThrows(
            ...
            () -> linearGradientBuilder.withColor(invalid_randomColor9));

    String expectedExceptionMessage =
        "Gradients cannot contain more than " + Gradients.MaximumColorCount + " colors.";
    assertEquals(
        expectedExceptionMessage,
        exception.getMessage(),
        "The thrown exception's message should match the expected exception message.");
  ...
  void tryCreateLinearGradient_butTooManyColorsWereAdded_usingWithColors() {
    ...
    Throwable exception =
        assertThrows(
            IllegalStateException.class,
            () -> linearGradientBuilder.withColors(invalid_randomColor9));
  ...
  void tryCreateLinearGradient_butAddedNullColor_usingWithColor() {
    ...
    Throwable exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> linearGradientBuilder.withColor(invalid_nullColor));
  ...
  void tryCreateLinearGradient_butAddedNullColor_usingWithColors() {
    ...
    Throwable exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> linearGradientBuilder.withColors(invalid_nullColor));
  ...
  void tryCreateLinearGradient_butTooFewColorsWereAddedToBuild_withColorCountOfOne() {
    ...
    LinearGradientBuilder linearGradientBuilder =
        Gradients.linearGradient(randomStartingPoint, randomEndingPoint).withColor(randomColor1);
    Throwable exception = assertThrows(IllegalStateException.class, linearGradientBuilder::build);
