...
class GradientsTests {
  ...
  private static Boundary randomEndingBoundary() {
    return Boundary.values()[
        Maths.randomInteger(Boundary.values().length / 2, Boundary.values().length - 1)];
  }

  @Test
  void checkGenerateLinearGradientPaints_usingDrawableAndRandomBoundaries_shouldNotFail() {
    int generatedGradientCount = 255;
    LinearGradientPaint[] generatedLinearGradients =
        new LinearGradientPaint[generatedGradientCount];
    Drawable mockBoundariesDrawable = new MockBoundariesDrawable();

    assertDoesNotThrow(
        () -> {
          for (int i = 0; i < generatedGradientCount; i++) {
            generatedLinearGradients[i] =
                Gradients.randomLinearGradient(
                    mockBoundariesDrawable, randomBeginningBoundary(), randomEndingBoundary());
          }
        },
  ...
  @Test
  void
      checkGenerateLinearGradientPaintsWithRandomAlpha_usingDrawableAndRandomBoundaries_shouldNotFail() {
    int generatedGradientCount = 255;
    LinearGradientPaint[] generatedLinearGradients =
        new LinearGradientPaint[generatedGradientCount];
    Drawable mockBoundariesDrawable = new MockBoundariesDrawable();
    ...
    assertDoesNotThrow(
        () -> {
          for (int i = 0; i < generatedGradientCount; i++) {
            generatedLinearGradients[i] =
                Gradients.randomLinearGradientWithAlpha(
                    mockBoundariesDrawable, randomBeginningBoundary(), randomEndingBoundary());
          }
        },
  ...
  @Test
  void
      checkGenerateLinearGradientPaintsWithRandomAlpha_usingRandomStartingAndEndingPointfs_shouldNotFail() {
    int generatedGradientCount = 255;
    LinearGradientPaint[] generatedLinearGradients =
        new LinearGradientPaint[generatedGradientCount];
    Pointf randomStartingPosition = randomPointf();
  ...
  void checkGenerateRadialGradientPaints_usingDrawable_shouldNotFail() {
    int generatedGradientCount = 255;
    RadialGradientPaint[] generatedRadialGradients =
        new RadialGradientPaint[generatedGradientCount];
    Drawable mockBoundariesDrawable = new MockBoundariesDrawable();
  ...
  @Test
  void
      checkGenerateRadialGradientPaints_usingRandomPointfCenterAndRandomFloatRadius_shouldNotFail() {
    int generatedGradientCount = 255;
    RadialGradientPaint[] generatedRadialGradients =
        new RadialGradientPaint[generatedGradientCount];
  ...
  @Test
  void
      checkGenerateRadialGradientPaintsWithRandomAlpha_usingRandomPointfCenterAndRandomFloatRadius_shouldNotFail() {
    int generatedGradientCount = 255;
    RadialGradientPaint[] generatedRadialGradients =
        new RadialGradientPaint[generatedGradientCount];
    Pointf randomCenterpoint = randomPointf();
