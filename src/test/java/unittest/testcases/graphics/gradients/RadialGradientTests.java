...
class RadialGradientTests {
  ...
  void checkCreateRadialGradient_withTwoRandomColors_usingRandomLocations() {
    ...
    RadialGradientPaint expectedRadialGradientPaint =
    ...
    RadialGradientPaint actualRadialGradientPaint =
        Gradients.radialGradient(randomCenterpoint, randomRadius)
            .withColor(randomColor1)
            .withColor(randomColor2)
            .build();

    assertEquals(
        expectedRadialGradientPaint.getCenterPoint(),
        actualRadialGradientPaint.getCenterPoint(),
        "The created Radial gradient's starting point should match the expected Radial gradient's starting point.");
    assertEquals(
        expectedRadialGradientPaint.getRadius(),
        actualRadialGradientPaint.getRadius(),
        "The created Radial gradient's ending point should match the expected Radial gradient's ending point.");
    assertArrayEquals(
        expectedRadialGradientPaint.getColors(),
        actualRadialGradientPaint.getColors(),
        "The created Radial gradient's colors should match the expected Radial gradient's colors.");
    assertEquals(
        expectedRadialGradientPaint.getCycleMethod(),
        actualRadialGradientPaint.getCycleMethod(),
        "The created Radial gradient's cycle method should match the expected Radial gradient's cycle method.");
    assertEquals(
        expectedRadialGradientPaint.getColorSpace(),
        actualRadialGradientPaint.getColorSpace(),
        "The created Radial gradient's color space should match the expected Radial gradient's color space.");
    assertEquals(
        expectedRadialGradientPaint.getTransform(),
        actualRadialGradientPaint.getTransform(),
        "The created Radial gradient's transform should match the expected Radial gradient's transform.");
    assertEquals(
        expectedRadialGradientPaint.getTransparency(),
        actualRadialGradientPaint.getTransparency(),
        "The created Radial gradient's transparency should match the expected Radial gradient's transparency.");
  ...
  @Test
  void
      checkCreateRadialGradient_withThreeRandomColors_usingRandomLocations_usingWithColorsMethod() {
    Color randomColor1 = randomColor();
    Color randomColor2 = randomColor();
    Color randomColor3 = randomColor();
  ...
  @Test
  void
      checkCreateRadialGradient_withSevenRandomColors_usingRandomLocations_usingWithColorsMethod() {
    Color randomColor1 = randomColor();
    Color randomColor2 = randomColor();
    Color randomColor3 = randomColor();
    Color randomColor4 = randomColor();
  ...
  @Test
  void
      checkCreateRadialGradient_withEightRandomColors_usingRandomLocations_usingWithColorsMethod() {
    Color randomColor1 = randomColor();
    Color randomColor2 = randomColor();
    Color randomColor3 = randomColor();
    Color randomColor4 = randomColor();
  ...
  void tryCreateRadialGradient_butPositionUsesARadiusThatIsTooSmall_radiusWithValueOfZero() {
    ...
    Throwable exception =
        assertThrows(
            ...
            () -> Gradients.radialGradient(randomCenterpoint, invalid_radius));
  ...
  void tryCreateRadialGradient_butTooManyColorsWereAdded_usingWithColor() {
    ...
    RadialGradientBuilder RadialGradientBuilder =
        Gradients.radialGradient(randomCenterpoint, randomRadius)
            .withColor(randomColor1)
            .withColor(randomColor2)
            .withColor(randomColor3)
    ...
    Throwable exception =
        assertThrows(
            ...
            () -> RadialGradientBuilder.withColor(invalid_randomColor9));
  ...
  void tryCreateRadialGradient_butTooManyColorsWereAdded_usingWithColors() {
    ...
    Throwable exception =
        assertThrows(
            IllegalStateException.class,
            () -> RadialGradientBuilder.withColors(invalid_randomColor9));
  ...
  void tryCreateRadialGradient_butAddedNullColor_usingWithColor() {
    ...
    Throwable exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> RadialGradientBuilder.withColor(invalid_nullColor));
  ...
  void tryCreateRadialGradient_butAddedNullColor_usingWithColors() {
    ...
    Throwable exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> RadialGradientBuilder.withColors(invalid_nullColor));
  ...
  void tryCreateRadialGradient_butTooFewColorsWereAddedToBuild_withColorCountOfOne() {
    ...
    RadialGradientBuilder RadialGradientBuilder =
        Gradients.radialGradient(randomCenterpoint, randomRadius).withColor(randomColor1);
    Throwable exception = assertThrows(IllegalStateException.class, RadialGradientBuilder::build);
