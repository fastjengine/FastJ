...
class Polygon2DTests {
  ...
  void checkPolygon2DCreation_withPointfArrayParam() {
    ...
    assertEquals(
        Polygon2D.DefaultFill,
        polygon2D.getFill(),
        "The created polygon's paint should match the default paint.");
    assertEquals(
        Polygon2D.DefaultRenderStyle,
        polygon2D.getRenderStyle(),
        "The created polygon's render style option should match the default render style.");
    assertEquals(
        Drawable.DefaultShouldRender,
        polygon2D.shouldRender(),
        "The created polygon's 'show' option should match the default shouldRender option.");
    assertEquals(
        Polygon2D.DefaultOutlineStroke,
        polygon2D.getOutlineStroke(),
        "The created polygon's outline stroke option should match the default outline stroke.");
    assertEquals(
        Polygon2D.DefaultOutlineColor,
        polygon2D.getOutlineColor(),
        "The created polygon's outline color option should match the default outline color.");
    assertEquals(
        Transform2D.DefaultTranslation,
        polygon2D.getTranslation(),
        "The created polygon's translation should match an origin translation.");
    assertEquals(
        Transform2D.DefaultRotation,
        polygon2D.getRotation(),
        "The created polygon's rotation should match an origin rotation.");
    assertEquals(
        Transform2D.DefaultScale,
        polygon2D.getScale(),
        "The created polygon's scaling should match an origin scale.");
    assertArrayEquals(
        square,
        polygon2D.getOriginalPoints(),
        "The created polygon's Pointf array should match the original Pointf array.");
  }

  @Test
  void
      checkPolygon2DCreation_withPointfArrayParam_andRandomlyGeneratedRenderStyleFillOutlineParams_andShouldRenderParam() {
    Pointf[] square = DrawUtil.createBox(0f, 0f, 50f);

    Color randomColor = DrawUtil.randomColorWithAlpha();
    RenderStyle renderStyle =
        RenderStyle.values()[Maths.randomInteger(0, RenderStyle.values().length - 1)];
    boolean shouldRender = Maths.randomBoolean();

    Polygon2D polygon2D =
        Polygon2D.create(square, renderStyle, shouldRender).withFill(randomColor).build();

    assertEquals(
        randomColor,
        polygon2D.getFill(),
        "The created polygon's paint should match the randomly generated paint.");
    assertEquals(
        renderStyle,
        polygon2D.getRenderStyle(),
        "The created polygon's render style option should match the default render style.");
    assertEquals(
        shouldRender,
        polygon2D.shouldRender(),
        "The created polygon's 'show' option should match the randomly generated shouldRender option.");
    assertEquals(
        Polygon2D.DefaultOutlineStroke,
        polygon2D.getOutlineStroke(),
        "The created polygon's outline stroke option should match the default outline stroke.");
  ...
  @Test
  void
      checkPolygon2DCreation_withPointfArrayParam_andRandomlyGeneratedRenderStyleFillOutlineParams_andShouldRenderParam_andRandomlyGeneratedTransformParams() {
    Pointf[] square = DrawUtil.createBox(0f, 0f, 50f);
    ...
    Polygon2D polygon2D =
        Polygon2D.create(square, renderStyle, shouldRender)
    ...
    assertEquals(
        outlineStroke,
        polygon2D.getOutlineStroke(),
        "The created polygon's outline stroke option should match the randomly generated outline stroke.");
    assertEquals(
        outlineColor,
        polygon2D.getOutlineColor(),
        "The created polygon's outline color option should match the randomly generated outline color.");
    assertEquals(
        randomTranslation,
        polygon2D.getTranslation(),
        "The created polygon's translation should match the randomly generated translation.");
    assertEquals(
        randomRotation,
        polygon2D.getRotation(),
        "The created polygon's rotation should match the randomly generated rotation.");
    assertEquals(
        expectedNormalizedRotation,
        polygon2D.getRotationWithin360(),
        "The created model's normalized rotation should match the normalized rotation.");
    assertEquals(
        randomScale,
        polygon2D.getScale(),
        "The created polygon's scaling should match the randomly generated scale.");
    assertArrayEquals(
        square,
        polygon2D.getOriginalPoints(),
        "The created polygon's Pointf array should match the original Pointf array.");
  ...
  @Test
  void
      checkPolygon2DCreation_withPointfArrayParam_andRandomlyGeneratedRenderStyleFillOutlineParams_andShouldRenderParam_andRandomlyGeneratedTransformParams_usingMethodChaining() {
    Pointf[] square = DrawUtil.createBox(0f, 0f, 50f);
  ...
  void checkModifyPointsOfPolygon2D_withTransformResetting() {
    ...
    assertArrayEquals(
        newSquarePoints,
        square.getPoints(),
        "The expected points should match the square's points -- no transformations have been performed.");
    assertArrayEquals(
        newSquarePoints,
        square.getOriginalPoints(),
        "The expected points should match the square's points.");
    assertEquals(
        Transform2D.DefaultTranslation,
        square.getTranslation(),
        "The square's translation should match the default Transform2D.translation.");
    assertEquals(
        Transform2D.DefaultRotation,
        square.getRotation(),
        "The square's rotation should match the default Transform2D.rotation.");
    assertEquals(
        Transform2D.DefaultScale,
        square.getScale(),
        "The square's scale should match the default Transform2D.scale.");
  }
  ...
  void checkModifyPointsOfPolygon2D_withoutTransformResetting() {
    ...
    assertFalse(
        Arrays.deepEquals(newSquarePoints, square.getPoints()),
        "The expected points should not match the square's transformed points -- no transformations have been reset.");
    assertArrayEquals(
        newSquarePoints,
        square.getOriginalPoints(),
        "The expected points should match the square's points.");
    assertEquals(
        translationBeforeReset,
        square.getTranslation(),
        "The square's translation should match the translation before point modification.");
    assertEquals(
        rotationBeforeReset,
        square.getRotation(),
        "The square's rotation should match the rotation before point modification.");
    assertEquals(
        scaleBeforeReset,
        square.getScale(),
        "The square's scale should match the scale before point modification.");
  }

  @Test
  void checkPolygon2DTranslation_shouldMatchExpected() {
    Pointf[] originalPoints = DrawUtil.createBox(Pointf.Origin, 5f);
    Pointf randomTranslation = new Pointf(Maths.random(0f, 1f), Maths.random(0f, 1f));
    ...
    assertArrayEquals(
        expectedTranslatedPoints,
        actualTranslatedPoints,
        "The actual Pointf array, which has been translated, should match the expected Pointf array.");
  }
  ...
  void checkPolygon2DRotation_aroundOrigin_shouldMatchExpected() {
    ...
    assertArrayEquals(
        expectedRotatedPoints,
        actualRotatedPoints,
        "The actual Pointf array, which has been rotated about the origin, should match the expected Pointf array.");
  }
  ...
  void checkPolygon2DRotation_aroundPolygonCenter_shouldMatchExpected() {
    ...
    assertArrayEquals(
        expectedRotatedPoints,
        actualRotatedPoints,
        "The actual Pointf array, which has been rotated about its center, should match the expected Pointf array.");
  }
  ...
  void checkPolygon2DRotation_aroundRandomPoint_shouldMatchExpected() {
    ...
    assertArrayEquals(
        expectedRotatedPoints,
        actualRotatedPoints,
        "The actual Pointf array, which has been rotated about "
            + randomCenter
            + ", should match the expected Pointf array.");
  }
  ...
  void checkPolygon2DScaling_aroundOrigin_shouldMatchExpected() {
    ...
    assertArrayEquals(
        expectedScaledPoints,
        actualScaledPoints,
        "The actual Pointf array, which has been scaled, should match the expected Pointf array.");
  }
  ...
  void checkPolygon2DScaling_aroundPolygonCenter_shouldMatchExpected() {
    ...
    assertArrayEquals(
        expectedScaledPoints,
        actualScaledPoints,
        "The actual Pointf array, which has been scaled around its center, should match the expected Pointf array.");
  }
  ...
  void checkPolygon2DScaling_aroundRandomPoint_shouldMatchExpected() {
    ...
    assertArrayEquals(
        expectedScaledPoints,
        actualScaledPoints,
        "The actual Pointf array, which has been scaled around "
            + randomScaling
            + ", should match the expected Pointf array.");
  }
}
